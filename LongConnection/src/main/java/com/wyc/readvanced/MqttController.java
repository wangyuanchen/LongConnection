...
public class MqttController {
     ...
     */
    @ResponseBody
    @GetMapping(value = "/mqtttopic", produces ="text/html")
    public ResponseEntity<String> sendMqttTopic(@RequestParam(value = "msg") String message,@RequestParam(value = "topic") String topic) {
